...
#     """
#     검사 내역 목록 조회
#     - 차트와 동일한 필터 네이밍(alias) 지원:
#       start_date/end_date, factory/process/equipment, partNo/item, inspType/workType/shiftType
#       (기존 plant/itemNumber/inspectionType 등도 그대로 사용 가능)
#     """
#     try:
...
#     """ 공장 드롭다운 옵션 (차트/그리드 공통 필터 alias 지원) """
#     try:
